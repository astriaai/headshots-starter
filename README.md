...
If you want to contribute to the codebase make sure you fork the repository, create a new branch in the forked repository and open a pull request that points to `dev` branch.
